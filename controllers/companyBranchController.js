...
exports.getcompanyBranch = async (req, res) => {
  try {
    var sql = "SELECT branch.branch_id,master.company_name,branch.branch_name,branch.status,branch.city FROM company_branch branch INNER JOIN company_master master ON branch.company_id =master.company_id ORDER BY branch.created_date DESC";
